...
Permitir que un jugador encuentre o publique una partida cercana en contexto, comprenda cuándo y a qué se jugará, solicite una plaza y conozca claramente si sigue pendiente o ha sido aceptada, con el mínimo esfuerzo y sin publicar innecesariamente una ubicación precisa.
...
- **Confianza progresiva:** incorporar mecanismos de seguridad o reputación en proporción a riesgos observados, sin simular una red social completa en el MVP.
